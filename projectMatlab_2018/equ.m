...
% Last Modified by GUIDE v2.5 20-Apr-2018 18:45:54
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
text_string=get(handles.edit1,'string');
if isempty(text_string)
  errordlg('write equation','Error') 
  set(handles.text1, 'String', ' ');
else
  y=solve(text_string)
  y=num2str(double(y))
  if isempty(y)
   errordlg('Do not have a root','Error') 
  else
  set(handles.text1,'String',y)
  end
end
